...
import json
import matplotlib
matplotlib.use('Agg')  # Sử dụng non-GUI backend để tránh lỗi
...
def index():
    ...
    try:
        ...
        if weather_response.status_code == 200:
            ...
            if 'current_weather' in weather_data:
                ...
                weather = {'name': 'Hà Nội', 'weather': [{'description': desc}], 'current_weather': {'temperature': temp}}
    ...
    return render_template('index.html', gold=gold, weather=weather, currency=currency,
                           chart_url='static/gold_chart.png', error=error)
